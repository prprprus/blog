...
**表锁的读锁规则：对于加了读锁的表，会阻塞任何写操作或者申请写锁的操作，直到读锁被释放**
...
**表锁的写锁规则：对于加了写锁的表，会阻塞任何没有持有锁的会话任何操作（读写操作、申请多的操作），直到写锁被释放**
...
**行锁的读锁规则是：对于加了读锁的事务，会阻塞其他事务的写操作或者申请写锁的操作**

#### 写锁的规则

**行锁的写锁规则是：对于加了写锁的事务，会阻塞其他事务的写操作或者申请读和写锁的操作**

> 可以看到：表锁的读写锁针对的是更大的表，行锁的读写锁针对的是更小的事务
